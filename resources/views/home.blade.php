...
<body class="bg-white text-gray-800">
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="md:w-3/5 md:pr-8 pl-[220px] flex flex-col justify-end mb-[200px]">
                <h1 class="text-4xl font-bold">
                    ...
                    <div class="block text-5xl">Wilayah <span id="typing"
                            class="text-purple-700 typing-effect text-6xl"></span></div>
                </h1>
    ...
    <script>
        ...
        // Typing effect logic
        const regions = ["Denpasar", "Badung", "Gianyar", "Tabanan", "Karangasem", "Jembrana", "Bangli", "Buleleng",
            "Klungkung"
        ];
        let index = 0;
        let charIndex = 0;
