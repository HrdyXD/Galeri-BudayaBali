...
<body class="bg-white text-gray-800">
    ...
    <!-- Main Content -->
    <section id="main-content" class="mt-[-100px] flex justify-center items-center py-12 h-[200vh]">
        <div id="cover" class="w-full max-w-screen-xl hover:scale-105 transition-transform duration-300">
        </div>
    </section>
